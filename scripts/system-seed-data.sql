...
INSERT INTO users (id, email, password_hash, full_name, email_verified, created_at) VALUES
    ('11111111-1111-1111-1111-111111111111', 'admin@reqquli.com', '$2b$10$wfdJ6H6GSR41wtAVsqLlae7O9kkIOUKFqCX4EnAreyjV0EfHcAPn2', 'Admin User', true, NOW())
...
('UR-Q001', 'REQQULI: User Authentication',
...
BEGIN
  RAISE NOTICE '';
  RAISE NOTICE '====================================';
  RAISE NOTICE 'REQQULI System Requirements Loaded';
  RAISE NOTICE '====================================';
